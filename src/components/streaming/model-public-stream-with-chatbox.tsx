...
import {
  getStreamConversationSuccess, loadStreamMessages, resetStreamConversation, resetStreamMessage
} from '@redux/stream-chat/actions';
import { streamService } from '@services/stream.service';
import {
  Button, ButtonProps, Col, message, Row
} from 'antd';
    ...
    <Row className={style['public-stream-with-chatbox']}>
      ...
      <Col xs={24} sm={24} md={12}>
        ...
        <div className="stream-box-model">
          ...
          <div className="stream-footer-mobile"><Button {...btnProps} /></div>
        </div>
      </Col>
      <Col xs={24} sm={24} md={12}>
        <ChatBox
