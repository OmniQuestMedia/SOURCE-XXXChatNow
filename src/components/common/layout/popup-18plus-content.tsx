import './popup-18plus-content.module.less';

export function Popup18PlusContent() {
  return (
    <div>
      <div className="confirmage__header text-center">YOU MUST BE OVER 18 AND AGREE TO THE TERMS BELOW BEFORE CONTINUING:</div>
      <div className="confirmage__description text-center">
        <div className="scroll">
          <p>
            ...
            <br />
            The profiles content and photographs
            <br />
            The player and his functionalities
            <br />
          ...
          <ul>
            ...
            <li>
              I understand that my use of this website is governed by the website&apos;s
              <a href="/page/terms-and-conditions">Terms</a>
              {' '}
              which I have reviewed and accepted, and I agree to be bound by such Terms.
            </li>
            <li>
              I agree that by entering this website, I am subjecting myself, and any business entity in which I have any legal or equitable interest, to the personal jurisdiction of the State of Florida, Miami-Dade County, should any dispute arise at any time between this website, myself and/or such business entity;
            </li>
            <li>
        ...
        <p className="notice-txt">THIS SITE ACTIVELY COOPERATES WITH LAW ENFORCEMENT IN ALL INSTANCES OF SUSPECTED ILLEGAL USE OF THE SERVICE, ESPECIALLY IN THE CASE OF UNDERAGE USAGE OF THE SERVICE.</p>
      </div>
    </div>
  );
}
